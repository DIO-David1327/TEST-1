        ...
        -1 < window.location.href.indexOf("game/index")) {
            ...
            MH.LoadIcon = setInterval(function() {
                $("#loader").length && (0 == MH.player_banned && $("#loader_content").append($("<img/>", {
                    id: "MHLoading",
                    src: "https://www.tuto-de-david1327.com/medias/images/mhloading-david1327.png"
                })),
...
MH.Subtitles = function() {
    if (MH.Set.MSb) {
        ...
        for (e in p)
            ...
            a += '<div"><div style="display:inline-block; background-color:#A8532A40;"><img padding-right: 2px;" alt="" src="https://www.tuto-de-david1327.com/medias/images/player.gif">' + mhUtl.lnkPlayerCol(t.player_id, t.player_name, "#E07030") + "</div></div>",
...
MH.TimerInit = function() {
    ...
    $("#MH_Timer").append($("<div/>", {
        id: "MH_TimerS2",
        style: "float:right; width:14px; height:21px; display:block; background:url('https://www.tuto-de-david1327.com/medias/images/digi.gif') -140px 0px"
    })).append($("<div/>", {
        id: "MH_TimerS1",
        style: "float:right; width:14px; height:21px; display:block; background:url('https://www.tuto-de-david1327.com/medias/images/digi.gif') -140px 0px"
    })).append($("<div/>", {
        id: "MH_TimerD2",
        style: "float:right; width:3px;  height:21px; display:block; background:url('https://www.tuto-de-david1327.com/medias/images/digi.gif') -157px 0px"
    })).append($("<div/>", {
        id: "MH_TimerM2",
        style: "float:right; width:14px; height:21px; display:block; background:url('https://www.tuto-de-david1327.com/medias/images/digi.gif') -140px 0px"
    })).append($("<div/>", {
...
function _mh5761928745() {
    ...
    this.lnkPlayerIco = function(e, t) {
        return '<img style="float: left; padding-right: 2px;" alt="" src="https://www.tuto-de-david1327.com/medias/images/player.gif">' + this.lnkPlayer(e, t)
    }
    ,
...
function mhMenu_Object(e, t, n, i) {
    ...
    default:
        ...
        (a = e) || (a = !1),
        null == e && (a = "https://www.tuto-de-david1327.com/medias/images/null.gif"),
        r = n,
        l = t;
        break;
    case "bld":
        ...
        ,
        "place" == e && (a = "https://www.tuto-de-david1327.com/medias/images/place.gif"),
...
function mhMenu(e) {
    ...
    this.addSub = function(e, t) {
        ...
        return n.gid = i,
        n.img = null == t ? "https://www.tuto-de-david1327.com/medias/images/null.gif" : void 0 !== t && t,
        n.txt = e,
        o.push(n),
        n
    }
    ...
    this.poupAT = function(e, t) {
        ...
        $("#" + i).find("ul li").each(function(e, t) {
            $(this).css("background-image", "url(https://www.tuto-de-david1327.com/medias/images/pu-bg.png)"),
    ...
    this.HtmlWnd = function() {
        for (var e, t = $("<ul/>", {
            ...
            o[n].isSub() ? (t.append($("<li/>", {
                sub: o[n].getID
            }).html(e + '<span style="position:relative: top:-1px; font-size:14px;">' + o[n].txt + '</span><img src="https://www.tuto-de-david1327.com/medias/images/marr.gif" style="float:right;">')),
...
MH.BBCode_2ForumWnd = function(e) {
    ...
    var t = $("<span/>", {}).html(MH.Lang.bbc2f_opi + ".").append($("<p/>", {}).html(MH.Lang.bbc2f_in + ":").append($("<textarea/>", {
        ...
        i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = i.replace(/\[ally\]/g, "[img]medias/images/ally.gif[/img] [b]")).replace(/\[\/ally\]/g, "[/b]")).replace(/\[player\]/g, "[img]https://www.tuto-de-david1327.com/medias/images/player.gif[/img] [b]")).replace(/\[\/player\]/g, "[/b]")).replace(/\[town\]/g, "[img]https://www.tuto-de-david1327.com/medias/images/town.gif[/img] [b]")).replace(/\[\/town\]/g, "[/b]")).replace(/\[island\]/g, "[img]https://grmh.pl/e/9/island.gif[/img] [b]")).replace(/\[\/island\]/g, "[/b]")).replace(/\[quote\]/g, "")).replace(/\[\/quote\]/g, "")).replace(/\[\*\]/g, "[tr][td]")).replace(/\[\|\]/g, "[/td][td]")).replace(/\[\/\*\]/g, "[/td][/tr]")).replace(/\[size=7\]/g, "[size=1]")).replace(/\[size=8\]/g, "[size=1]")).replace(/\[size=9\]/g, "[size=2]")).replace(/\[size=10\]/g, "[size=2]"),
...
MH.wo.SetLang = function() {
    ...
    i.append($("<div/>", {}).append($("<img/>", {
        id: "hm_lngSel",
        src: "https://www.tuto-de-david1327.com/medias/images/flag.48." + MH.LngUse + ".png"
    }))),
    i.append("<br>"),
    ...
    if ("edit" != MH.Set.lng) {
        ...
        for (e in mhCNST.CountryNames)
            mhCNST.CountryNames.hasOwnProperty(e) && "zz" != e && t.append($("<img/>", {
                sel: e,
                src: "https://www.tuto-de-david1327.com/medias/images/flag.16." + e + ".png"
            }).click(function() {
                var e = $(this).attr("sel");
                $("#hm_lngSel").attr("sel", e),
                $("#hm_lngSel").attr("src", "https://www.tuto-de-david1327.com/medias/images/flag.48." + e + ".png"),
        ...
        }).append(l))).append('<p><img src="' + + "https://www.tuto-de-david1327.com/medias/images/flag.16." + MH.eLng.can + '.png"/>&nbsp&nbsp<font color="#F01010">███</font> -> no translation <font color="#000000">███</font> -> previous translation <font color="#0000F0">███</font> -> your translation</p>'),
...
MH.rep.BaseRD = function (e, t) {
                        ...
                        switch (o.att = MH.htm.PlayerNFO(o.att, r.find("#report_sending_town")),
                            ...
                            case "illusion":
                                o.efekt.det = "ten atak już doszedł",
                                    o.efekt.det2 = "";
                                var t = !1, e = "#toolbar_activity_commands_list .illusion.outgoing";
                                $(e).length || (t = !0,
                ...
                case "found":
                    !function () {
                        o.title = r.find("#report_report_header").html().strip_tags().replace("&nbsp;", " ").trim(),
                            ...
                            o.att = MH.htm.PlayerNFO(o.att, r.find("#report_sending_town")),
                            o.def = MH.htm.PlayerNFO(o.def, r.find("#report_receiving_town"));
                        var e = 0 == r.find("#report_game_body p a.gp_town_link").length ? "" : MH.bbc(MH.Link2Struct(r.find("#report_game_body p a.gp_town_link").attr("href")).id.toString(), "town"), t = 0 == r.find("#report_game_body p a.gp_player_link").length ? "" : MH.bbc(r.find("#report_game_body p a.gp_player_link").html(), "player");
        ...
        function S() {
            ...
            var t = 0 == r.find(e + "a.gp_town_link").length ? "" : MH.bbc(MH.Link2Struct(r.find(e + "a.gp_town_link").attr("href")).id.toString(), "town"), n = 0 == r.find(e + "a.gp_town_link:eq(1)").length ? "" : MH.bbc(MH.Link2Struct(r.find(e + "a.gp_town_link:eq(1)").attr("href")).id.toString(), "town"), i = 0 == r.find(e + "a.gp_player_link").length ? "" : MH.bbc(r.find(e + "a.gp_player_link").html(), "player");
...
MH.initAll = function() {
    if (MH.ScriptAtcive) {
        ...
        add = $("<div/>", {
            ...
            style: "position:absolute; left:1px; top:3px;",
            src: "https://www.tuto-de-david1327.com/medias/images/logo.gif"
        }))).append($("<div/>", {
            id: "MH_Timer",
            ...
            style: 'background:url("https://www.tuto-de-david1327.com/medias/images/btnico.png") -0px 0; display:block; width: 24px; height: 24px;'
        }))).append($("<span/>", {
            id: "Menu_1",
            class: "circle_button_small"
        }).append($("<span/>", {
            style: 'background:url("https://www.tuto-de-david1327.com/medias/images/btnico.png") -24px 0; display:block; width: 24px; height: 24px;'
        }))).append($("<span/>", {
            id: "Menu_4",
            class: "circle_button_small"
        }).append($("<span/>", {
            style: 'background:url("https://www.tuto-de-david1327.com/medias/images/btnico.png") -96px 0; display:block; width: 24px; height: 24px;'
        }))))).append($("<div/>", {
            id: "HMTowns",
            style: "text-align:left; padding-left:10px; background:url('" + MH.Home + "medias/images/LayC.gif') repeat scroll 0px 0px rgba(0, 0, 0, 0)"
        })).append("<div style=\"display:block; width:145px; height:3px; background:url('https://www.tuto-de-david1327.com/medias/images/layz.gif'\">&nbsp</div>"),
        ...
        for (var b = [6, 7, 5, 8, 9, 3], add = $("<div/>", {
            ...
            add.append($("<span/>", {
                ...
                style: "background:url('https://www.tuto-de-david1327.com/medias/images/btnico.png') -" + 24 * b[n] + "px 0; display:block; width: 24px; height: 24px;"
            })));
        ...
        $('<a id="MH_attsup" style="z-index:7; position:absolute; top:3px; left:366px;" href="#"><img src="https://www.tuto-de-david1327.com/medias/images/tbaw.png" style="border-width: 0px" /></a></a>').append($("<div/>", {
            id: "MH_mna",
        ...
        $("#ui_box>.gods_area .gods_favor_button_area").append($("<span/>", {
            ...
            style: 'background:url("https://www.tuto-de-david1327.com/medias/images/btnico.png") -48px 0; display:block; width: 24px; height: 24px;'
        }))),
...
MH.PoupMenu = function() {
    ...
    n.add("https://www.tuto-de-david1327.com/medias/images/player.gif", DM.getl10n("layout").main_menu.items.profile + " " + DM.getl10n("bbcodes").player.name, function() {
        Layout.playerProfile.open(Game.player_name, Game.player_id)
    }),
    Game.alliance_id && n.add("https://www.tuto-de-david1327.com/medias/images/flag.gif", DM.getl10n("layout").main_menu.items.profile + " " + DM.getl10n("bbcodes").ally.name, function() {
    ...
    (t = n.addSub(MH.Lang.themes, "https://www.tuto-de-david1327.com/medias/images/island.gif")).add("1" == MH.Set.theme ? "rb1.gif" : "rb0.gif", MH.Lang.Set_theme, function() {
    ...
    (t = n.addSub(MH.Lang.mLinks, "https://www.tuto-de-david1327.com/medias/images/link.gif")).add(MH.Home + "medias/images/mole.gif", MH.Lang.norka, function() {
